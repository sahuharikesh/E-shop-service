...
<p class="blkColor  text-white p-2 text-center d-print-none">Find the Sell Report...!</p>
        ...
        if(isset($_REQUEST['search'])){
            ...
            $result= $conn->query($sql);
                    if($result->num_rows > 0){
                        echo'<p class="blkColor text-center p-2 mt-4 text-white">Product Sold Details</p>';
                        echo'<table class="table text-center">
                             ...
                             echo '<td>'.$row['scost']*$row['quantity'].'</td>';
                          ...
                          echo '</tbody>
                             ...
                             <input type="submit" name="" id="" value="Print" class="btn  mx-4" onClick="window.print()">
                             </form>';   
                    }
                    else{
