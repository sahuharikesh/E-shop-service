...
<nav class="navbar navbar-expand-lg navbar-dark ">
  <a class="navbar-brand" href="dashboard.php"><img src="../images/white_logo_transparent.svg" class="logo1"></a><span class="navbar-text">&nbsp;&nbsp;Customer's Happiness is our aim..!</span>
 ...
 <div class="row">
    <nav class="col-sm-2 bg-light sidebar py-5  d-print-none">
        <div class="sidebar-sticky">
            ...
            <li class="nav-item mt-2">
            <a href="workOrder.php" class="nav-link <?php if(PAGE == 'workOrder'){echo 'active';} ?> "><i class="fa fa-globe mr-2"></i> Work Order</a>
            </li>
            <li class="nav-item mt-2">
            <a href="newOrder.php" class="nav-link <?php if(PAGE == 'newOrder'){echo 'active';} ?> "><i class="fab fa-accessible-icon mr-2"></i> New Order</a>
            </li>
            <li class="nav-item mt-2">
