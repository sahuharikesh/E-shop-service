...
<body class="back-image">
  ...
  <b><h2 class="text-center text-white"><b>Create an Account&nbsp;<i class="fas fa-user-check"></i></b></h2><hr class="w-25 mx-auto "></b>
    <div class="row ">
      <div class="col-md-8 offset-md-2 ">
        <form action="" class="shadow-lg p-5 formcontainer text-white " method="POST" >
          <div class="row">
            <div class="col-md-6">
          ...
          <div class="col-md-6">
              ...
              <div class="form-group">
                ...
                <textarea type="text" class="form-control" rows="5" placeholder="address" name="rAddress" autocomplete="off" required></textarea>
              </div>
          </div>
          </div>
          <button type="submit" class="btn1 btn text-white  mt-3 btn-block shadow-sm font-weight-bold " name="rSignup">Sign Up</button>
