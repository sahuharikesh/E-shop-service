 ...
 <div class="container-fluid">
    <div class="row justify-content-center mt-3">
        ...
        <p class="text-center">Admin Login </p>  
            ...
            <button type="submit" class="btn  mt-5 btn-block shadow-sm font-weight-bold " name="aSignup">Login</button>
            <?php if(isset($regmsg)) { echo $regmsg;} ?>
       </form>

       <div class="text-center"><a href="../index.php" class="btn btn1 mt-5 font-weight-bold shadow">Back to Home</a></div>
        </div>
    </div>
 </div>
