...
if(isset($_REQUEST['sellProd'])){
    ...
    {  
        ...
        $sql = "INSERT INTO `sell`( `cname`, `address`, `name`, `quantity`, `scost`, `sdate`) VALUES ('$cname','$address','$name','$quantity','$scost','$sdate')";
...
?>
    ...
    <input type="number" id="quantity" name="quantity" class="form-control" min="1" placeholder="quantity"
    ...
    <button type="submit" class="btn " name="sellProd">Submit</button>
    <a href="assest.php" class="btn btn1" name="close">Close</a>
    </div>
