...
if($_SESSION['is_adminlogin']){
 ...
 <p class="blkColor  text-white p-2 text-center d-print-none">Request of Customer</p>
    ...
    <?php
        ...
        if($result->num_rows > 0){
            while($row = $result->fetch_assoc()){
                ...
                echo '<input type="submit" value="View" class="btn  mr-3" name="view">';
                echo '<input type="submit" value="Close" class="btn btn1" name="close">';
                echo '</form>';
