...
<div class="col-sm-9 col-md-10">
    <div class=" mx-5 mt-5 card">
        <p class="blkColor text-center text-white p-2"><b>Order Details</b></p>
            <?php   
            $total = 0;
            if(isset($_REQUEST['view'])){
                ...
                $oid=$_REQUEST['oid'];
                $date=$_REQUEST['date'];
                $sql = "SELECT * FROM `cart` WHERE user='$user' AND date='$date'"; 
    ...
    <div class="text-center pt-5">
        <form action="" method="post" class="mb-3 mr-3 d-print-none d-inline">
            <input type="submit" name="" id="" value="Print" class="btn " onClick="window.print()">
            </form>
            <form action="newOrder.php" method="post" class="mb-3 mr-3 d-print-none d-inline">
            <input type="submit" value="Close" class="btn btn1">
            </form>
        </form>
    </div>
</div>
