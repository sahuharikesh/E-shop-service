...
<div class="col-sm-6 mt-4 mx-5 jumbotron">
    ...
    <form action="" class="mx-3" method="POST"autocomplete="off">
          ...
          <button type="submit" class="btn  mt-4 mb-3 btn-block shadow-sm font-weight-bold " name="rSignup">Add</button>
          <a href="technician.php" class="btn btn1   btn-block shadow-sm font-weight-bold">Close</a>
