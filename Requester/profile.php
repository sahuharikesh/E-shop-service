...
$sql = "SELECT email, name, mobile  FROM user WHERE email ='".$rEmail."' limit 1";
...
if(isset($_REQUEST['update'])){
    if($_REQUEST['rName'] == ""){
        ...
        $sql = "UPDATE user SET name = '$rName',mobile = '$rMobile' WHERE email='$rEmail'";
...
?>
    ...
    <div class="col-sm-6">
        <form action="" method="post" class="pt-5 mx-5">
            ...
            <div class="form-group">
                <label for="name">Mobile</label><input type="text" name="rMobile" id="rMobile" class="form-control"
                value="<?php echo $rMobile ?>">
            </div>
